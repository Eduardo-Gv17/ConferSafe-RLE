...
class Node(Base):
    ...
    due         = Column(String(20))          # "DD/MM/YYYY" — kept as string to match frontend
    ...
    parent_id   = Column(String, nullable=True)   # references another node id (not FK for flexibility)
